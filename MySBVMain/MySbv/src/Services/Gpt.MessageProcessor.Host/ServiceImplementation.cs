...
using Gpt.MessageProcessor.Host.Framework;
using Infrastructure.Logging;
using Vault.Integration.MessageProcessor;

namespace Gpt.MessageProcessor.Host
{
    /// <summary>
    ///     The actual implementation of the windows service goes here...
    /// </summary>
    [WindowsService("Gpt.MessageProcessor.Host",
        DisplayName = "Gpt.MessageProcessor.Host",
        Description = "The description of the Gpt.MessageProcessor.Host service.",
        EventLogSource = "Gpt.MessageProcessor.Host",
