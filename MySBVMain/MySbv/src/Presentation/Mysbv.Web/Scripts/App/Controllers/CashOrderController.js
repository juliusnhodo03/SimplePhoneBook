...
mySbvApp.controller("CashOrderController", function ($scope, $http) {
	// model
    $scope.model = model;
    ...
    // on-select upload 
    $scope.onUploadFileSelect = function (e) {
    ...
    $scope.addExtensionClass = function(extension) {
