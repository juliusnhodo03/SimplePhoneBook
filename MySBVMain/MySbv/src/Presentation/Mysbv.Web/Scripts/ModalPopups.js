...
var txtHtml = question + "<br/>";
    ...
    SetCustomControl: function(id, Value) {
       return ModalPopupsSupport.setControl(id, Value);
    },    
...
var ModalPopupsSupport = {
    ...
    setControl: function(id, parent) {
       document.getElementById(id).value = parent;
    return document.getElementById(id).value = parent;
    },    
