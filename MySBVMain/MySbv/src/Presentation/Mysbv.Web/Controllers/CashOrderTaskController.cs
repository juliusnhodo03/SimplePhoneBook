...
using Application.Modules.CashOrder.Approval;
...
namespace Mysbv.Web.Controllers
{
    ...
    public class CashOrderTaskController : BaseController
    {
        #region Variables
        ...
        public CashOrderTaskController(ICashOrderApprovalValidation cashOrderApprovalValidation, ILookup lookup)
        {
            _cashOrderApprovalValidation = cashOrderApprovalValidation;
            _lookup = lookup;
        }
        ...
        public ActionResult Task()
        {
            ...
            {
                IEnumerable<ListCashOrderTaskDto> approvals = _cashOrderApprovalValidation.All();
